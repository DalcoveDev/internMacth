        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-8">
            ...
            <div>
              ...
              <textarea 
                ...
                onChange={handleChange} 
                placeholder="List the skills, qualifications, and experience required (e.g., JavaScript, React, Python, etc.)"
              ></textarea>
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <button 
              ...
              className="px-6 py-3 bg-emerald-600 text-white font-medium rounded-md hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
            >
              {isSubmitting ? (
                <>
