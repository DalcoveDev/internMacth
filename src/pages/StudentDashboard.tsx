...
import { ClockIcon, CheckCircleIcon, XCircleIcon, FileTextIcon } from 'lucide-react';
      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div className="border-b border-gray-200">
          <nav className="flex -mb-px">
            ...
            <button onClick={() => setActiveTab('resume')} className={`py-4 px-6 text-center border-b-2 font-medium text-sm ${activeTab === 'resume' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}>
              Resume
            </button>
          </nav>
        </div>
        ...
        <div className="p-6">
          {activeTab === 'applications' && <div>
              <div className="flex justify-between items-center mb-6">
                ...
                <Link to="/search" className="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700">
                  Browse More Internships
                </Link>
              </div>
              {applications.length > 0 ? <div className="space-y-4">
                  {applications.map(application => <div key={application.id} className="border border-gray-200 rounded-lg p-4 flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-4 flex">
                          <Link to={`/application/${application.id}`} className="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <div className="mb-6">
                  ...
                  <div className="border border-dashed border-gray-300 rounded-lg p-6 text-center">
                    <div className="mb-3">
                      <FileTextIcon size={36} className="mx-auto text-gray-400" />
                    </div>
